...
public class UserAction extends BaseAction {
    ...
    protected String checkUserForDelete() throws Throwable {
        if (!this.existsUser(this.getUsername()) && null == this.userProfileManager.getProfile(this.getUsername())) {
            this.addActionError(this.getText("error.user.notExist"));
            return "userList";
            ...
            return "userList";
        } else if (this.existsUser(this.getUsername()) && !this.isEntandoUser(this.getUsername())) {
