INSERT INTO widgetcatalog ( code, titles, parameters, plugincode, locked, readonlypagewidgetconfig, widgetcategory, icon) VALUES ( 'jpseo_content_viewer', '<?xml version="1.0" encoding="UTF-8"?>
<properties>
