...
<div id="main" role="main">
    ...
    <s:form action="saveConfig" namespace="/do/jpsolr/Page/SpecialWidget/FacetNavTree"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <wpsa:include
                    value="/WEB-INF/plugins/jpsolr/apsadmin/jsp/portal/specialwidget/include/content-type-list.jsp" />
                <wpsa:include
                    value="/WEB-INF/plugins/jpsolr/apsadmin/jsp/portal/specialwidget/include/facet-list.jsp" />
            </div>
        </div>
