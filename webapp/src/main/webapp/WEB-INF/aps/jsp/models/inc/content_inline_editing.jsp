    ...
    <script>
        $(function () {
            setTimeout(function () {
                ...
                $('.editLabel').editable({
                    url: '<wp:info key="systemParam" paramName="applicationBaseURL" />api/legacy/en/inline/i18nlabel',
                    send: 'always',
                    ajaxOptions: {
                ...
                $('.editContent').editable({
                    url: '<wp:info key="systemParam" paramName="applicationBaseURL" />api/legacy/en/inline/content',
                    ajaxOptions: {
                        dataType: 'json', //assuming json response
                        type: 'put',
                        contentType: 'application/json',
